const INSIGHTS = {
  '2001': { title: 'Pre-Boom Baseline', notes: [
    ...
    'Post-Troubles legacy: Shankill, Falls, Ardoyne most deprived',
  ...
  '2006': { title: 'Celtic Tiger Peak', notes: [
    ...
    'Victoria Square transforming city centre',
    'Citigroup opened Belfast office (2005)',
  ]},
  ...
  '2016': { title: 'Mid-Recovery', notes: [
    ...
    'Student accommodation boom in Queens Quarter',
    'Concentrix, FinTrU established',
  ]},
  '2021': { title: 'Post-COVID', notes: [
    ...
    'City Quays 2 opened — major office anchor',
  ]},
  '2025': { title: 'Current State', notes: [
    ...
    'North Belfast showing no improvement',
  ]},
}
